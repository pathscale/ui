...
export const dividerStyles = cva(
	"flex items-center whitespace-nowrap relative",
	{
		...
		compoundVariants: [
			{
				horizontal: false,
				class: "before:content-[''] before:flex-1 before:h-0.5 after:content-[''] after:flex-1 after:h-0.5",
			},
			{
				horizontal: false,
				position: "center",
			...
			{
				horizontal: true,
				class: "before:content-[''] before:flex-1 before:w-0.5 before:h-auto after:content-[''] after:flex-1 after:w-0.5 after:h-auto",
			},
			{
				horizontal: true,
				position: "center",
