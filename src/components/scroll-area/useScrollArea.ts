...
export interface UseScrollAreaProps {
  ...
  visibility: Accessor<ScrollAreaVisibility>;
  isEnabled: Accessor<boolean>;
  onVisibilityChange?: Accessor<
    ((visibility: ScrollAreaVisibility) => void) | undefined
  >;
}
...
export const clearScrollAreaDataAttributes = (el: HTMLElement): void => {
...
export const applyControlledScrollAreaVisibility = (
  el: HTMLElement,
