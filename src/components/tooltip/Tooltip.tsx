...
const TooltipRoot: ParentComponent<TooltipRootProps> = (props) => {
  ...
  return (
    <TooltipContext.Provider value={ctx}>
      <span
        class={twMerge("tooltip", local.class, local.className)}
...
const TooltipTrigger: Component<TooltipTriggerProps> = (props) => {
  ...
  return (
    <div
      ...
      class={twMerge("tooltip__trigger", local.class, local.className)}
...
const TooltipContent: Component<TooltipContentProps> = (props) => {
  ...
  return (
    <div
      {...others}
      role="tooltip"
      class={twMerge("tooltip__content", local.class, local.className)}
...
const TooltipArrow: Component<TooltipArrowProps> = (props) => {
  ...
  return (
    <span
      {...others}
      class={twMerge("tooltip__arrow", local.class, local.className)}
